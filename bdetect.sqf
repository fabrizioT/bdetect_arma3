...
if(isNil "bdetect_bullet_max_proximity") then { bdetect_bullet_max_proximity = 7.5; }; 							// (Meters, Default 10) Maximum proximity to unit for triggering detection
